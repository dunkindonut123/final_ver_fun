...
import type { AdminChapterMaterialRow } from "@/lib/admin/queries/chapter-materials";
...
interface AdminMaterialsContentProps {
  initialChapters: AdminChapterMaterialRow[];
}

export function AdminMaterialsContent({ initialChapters }: AdminMaterialsContentProps) {
  ...
  const chaptersByLevel = useMemo(() => {
    const grouped = new Map<number, AdminChapterMaterialRow[]>();
